...
struct S2CMatchStart
{
    ...
    uint64_t time; /* probably time passed in seconds since a specific instant */
};
...
struct C2SOrS2CAction
{
    ...
    uint64_t time; /* C2S = 0, S2C = probably time passed in seconds since a specific instant */
